...
def DynaKitti_Dataset(root, test_seq, source_image_transform=None, target_image_transform=None, flow_transform=None,
    ...
    test_list = []
    image_list = []
    image_path = os.path.join(root, test_seq, 'image_2')
    posefile = os.path.join(root, test_seq, 'pose_left.txt') 
...
def Kitti_Dataset(root, test_seq, source_image_transform=None, target_image_transform=None, flow_transform=None,
                   co_transform=None, valid_transform = None, train_transform=None,
                    focalx = 320.0, focaly = 320.0, centerx = 320.0, centery = 240.0):
    '''
    # dataloader for only abandonedfactory/Easy
    ...
    print("test_seq : {}".format(test_seq))
    pose_list = np.loadtxt(posefile).astype(np.float32)
    #pose_list = kitti2tartan(pose_list)
