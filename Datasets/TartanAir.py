        ...
        for data_type_name in data_type_list:
            ...
            for subdir in subdir_list:
                ...
                for i in range(len(flow_list)):
                    ...
                    if dataset_name == 'hospital' and data_type_name == 'Easy' and subdir == 'P000':    
                        test_list.append([[image_list[i], image_list[i+1]], flow_list[i], mask_list[i], motion_list[i]])
                    elif dataset_name == 'amusement' or dataset_name == 'japanesealley':
                        train_list.append([[image_list[i], image_list[i+1]], flow_list[i], mask_list[i], motion_list[i]])
