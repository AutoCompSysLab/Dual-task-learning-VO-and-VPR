...
do
    ...
    CUDA_VISIBLE_DEVICES=2 python3 test.py --name_exp tartanvo_test --evaluation_data_dir /home/main/storage/gpuserver00_storage/tartanair_cvpr  --pretrained_flownet /home/main/workspace/jeongwook/TartanVO_flowformer_mixvpr_sum/snapshots/2023_09_12_15_57/flownet_epoch_3.pth --pretrained_posenet /home/main/workspace/jeongwook/TartanVO_flowformer_mixvpr_sum/snapshots/2023_09_12_15_57/posenet_epoch_3.pth --batch-size 8 --test_seq MH00$i
