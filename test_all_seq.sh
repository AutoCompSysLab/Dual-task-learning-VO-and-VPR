...
do
    ...
    CUDA_VISIBLE_DEVICES=4 python3 test.py --name_exp tartanvo_test --evaluation_data_dir /home/main/storage/gpuserver00_storage/tartanair_cvpr  --pretrained_model /home/main/workspace/jeongwook/TartanVO/snapshots/TartanVO_train_step2_flow+pose/epoch_$i.pth --batch-size 8 --test_seq MH001
