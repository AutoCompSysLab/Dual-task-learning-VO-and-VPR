...
do
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 python3 test.py --name_exp tartanvo_test --evaluation_data_dir /home/main/storage/gpuserver00_storage/tartanair_cvpr  --pretrained_flownet /home/main/workspace/jeongwook/Trans_TartanVO_mixvpr_sum_with_VPRdata_new/snapshots/2023_12_24_20_22/flownet_epoch_2.pth --pretrained_posenet /home/main/workspace/jeongwook/Trans_TartanVO_mixvpr_sum_with_VPRdata_new/snapshots/2023_12_24_20_22/posenet_epoch_2.pth --batch-size 8 --test_seq MH00$i
